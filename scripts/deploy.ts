...
const BASE_PATH = "./circuits/JayCircuit/";
...
async function main() {
  // deploy contract
  const Verifier = await ethers.getContractFactory("./contracts/JayCircuitVerifier.sol:Verifier");
